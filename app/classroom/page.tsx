              ...
              return (
                <Reveal key={resource.slug} delay={index * 0.05}>
                  <Link
                    ...
                    className="group flex h-full min-h-[330px] flex-col rounded-2xl border border-slate-200 bg-white p-6 transition duration-300 hover:-translate-y-1 hover:border-emerald-200 hover:shadow-soft"
                  >
                    <div className="flex items-start justify-between gap-3">
                      <span className="grid h-11 w-11 place-items-center rounded-xl bg-emerald-50 text-signal">
            ...
            <div className="space-y-3">
              {papers.map((resource, index) => (
                <Reveal key={resource.slug} delay={index * 0.025}>
                  <article className="group rounded-2xl border border-slate-200 bg-white p-5 transition duration-300 hover:border-emerald-200 hover:shadow-soft sm:p-6">
                    <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
                      ...
                      <Link
                        ...
                        className="inline-flex shrink-0 items-center justify-center gap-2 rounded-full border border-slate-200 px-4 py-2 text-sm font-semibold text-signal transition hover:border-signal hover:bg-emerald-50"
                      >
                        PDF 阅读
      ...
      <section className="border-t border-slate-200 bg-mist py-16">
        <Reveal className="container-page">
          <div className="grid gap-8 bg-ink p-8 text-white sm:p-12 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              <p className="eyebrow text-emerald-300">Knowledge to action</p>
